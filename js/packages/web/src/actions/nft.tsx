  ...
  /**const result: IArweaveResult = await (
    await fetch(
      ...
      env.startsWith('mainnet-beta')
        ? 'https://us-central1-principal-lane-200702.cloudfunctions.net/uploadFileProd2'  // CENTRAL
        : 'https://us-central1-principal-lane-200702.cloudfunctions.net/uploadFile2',    // CENTRAL
      {
        method: 'POST',
        body: data,
      },
